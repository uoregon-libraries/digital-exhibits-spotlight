...
ActiveRecord::Schema.define(version: 20200102172440) do
  ...
  create_table "spotlight_custom_search_fields", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "slug"
    t.string "field"
    t.text "configuration"
    t.bigint "exhibit_id"
  ...
  create_table "spotlight_languages", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "translations", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "locale"
    t.string "key"
    t.text "value"
