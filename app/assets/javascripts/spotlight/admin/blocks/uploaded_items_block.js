            ...
            '<div class="card d-flex dd3-content">',
              ...
              '<div class="card-header d-flex item-grid">',
                ...
                '<div class="main form-horizontal">',
                  ...
                  '</div>',
                  '<div class="field row mr-3">',
                    '<label for="' + this.formId('alt' + dataId) + '" class="col-form-label col-md-3"><%= i18n.t("blocks:uploaded_items:alt") %></label>',
                    '<input type="text" class="form-control col" id="' + this.formId('alt_' + dataId) + '" name="item[' + index + '][alt]" data-field="alt"/>',
                  '</div>',
                  '<div class="field row mr-3">',
